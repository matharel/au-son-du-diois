+++
title = "Vie locale & activités — autour de Die | Au son du Diois"
linkTitle = "Vie locale"
h1 = "Vie locale & Activités autour de Die"
description = "Activités et sorties autour de Die : Drôme Aventure, randonnées, marchés, dégustation de Clairette, baignades et bonnes adresses. Idéal pour groupes et familles."
weight = 40
+++

<section id="hero" style="margin:1rem 0;">
  <h2 style="font-size:1.3rem;font-weight:600;margin-bottom:0.4rem;">
    Que faire autour du gîte — nature, sport, marché & gastronomie
  </h2>
  <p style="max-width:40rem;margin:0;">
...
proposent des informations saisonnières et des circuits thématiques.
...
- **Parcours famille** : pistes courtes et ludiques.  
...
Le marché de Die (marché animé les **mercredis et samedis matin**) est un
rendez-vous incontournable pour produits locaux (fruits, fromages, charcuterie,
artisanat). Parfait pour constituer vos repas en cuisine collective.
:contentReference[oaicite:5]{index=5}

## Culture & patrimoine

- **Cathédrale Notre-Dame de Die** : visite patrimoniale au cœur de la ville
  (architecture et histoire locale). :contentReference[oaicite:6]{index=6}
...
- Randonnée guidée et atelier nature (nous pouvons vous mettre en relation avec
  des accompagnateurs locaux). :contentReference[oaicite:9]{index=9}
...
- Drôme Aventure — réservation activités accrobranche et aventures.
  :contentReference[oaicite:12]{index=12}
- Fiches « Clairette de Die » & caves locales pour dégustations.
...
- Drôme Aventure — https://www.drome-aventure.com/ .
  :contentReference[oaicite:16]{index=16}
- Page Clairette de Die / chemins des vignes —
  https://www.diois-tourisme.com/en/terroir/clairette-de-die-and-wines/ .
  :contentReference[oaicite:17]{index=17}
- Info baignade Le Claps —
...
<div style="margin:1rem 0;">
  ...
  <a href="/contact-disponibilites" style="display:inline-block;padding:0.7rem 1.2rem;margin-left:0.6rem;border:1px solid #2a5fd7;color:#2a5fd7;border-radius:0.4rem;text-decoration:none;font-weight:600;">
    Nous contacter
  </a>
</div>
